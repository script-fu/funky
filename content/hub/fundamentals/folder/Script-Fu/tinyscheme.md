...
title: TinyScheme
type: docs
url: "/hub/fundamentals/folder/script-fu/tinyscheme"
weight: 5
---

> **Note**: This content was copied from the [TinyScheme Manual.txt on GitLab] and may have changed upstream: https://gitlab.gnome.org/GNOME/gimp/-/blob/master/plug-ins/script-fu/libscriptfu/tinyscheme/Manual.txt
